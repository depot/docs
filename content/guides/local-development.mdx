...
meta:
  - title: Local Development | Guides | Depot Documentation
  - property: og:title
    content: How to use Depot for local development
  - property: twitter:title
    content: How to use Depot for local development
  - name: description
    content: Send your container builds to Depot for faster local development and share your persistent cache automatically with your colleagues.
