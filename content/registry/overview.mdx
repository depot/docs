...
Depot Registry is included in all plans. Registry storage counts toward the same included storage amount as your container build cache and [Depot Cache](/docs/cache/overview), which is 25 GB on Developer and 250 GB on Startup. Storage above the included amount is billed at **$0.20/GB/month**. There are no charges for data transfer into or out of the registry.
