...
You can create and update upstream registries from [Registry Settings](/orgs/_/registry/settings). Pull-through cache for an individual repository can only be configured when you create the repository.
...
1. Open the [Registry](/orgs/_/registry/repositories) page in the Depot dashboard.
...
| Google Container Registry | `https://gcr.io`                             | Basic auth: `_json_key` + service account JSON key     |
