...
Depot organizations can be connected to GitHub organizations in order to use [Depot GitHub Actions Runners](/docs/github-actions/overview). This allows Depot runners to be used in GitHub Actions workflows and jobs to accelerate your entire CI/CD pipeline.
