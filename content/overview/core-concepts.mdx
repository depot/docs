---
title: Core Concepts
longTitle: Core Concepts of Depot
description: Learn about the fundamental concepts that Depot is built on for faster Docker image builds.

meta:
  - title: Core Concepts | Depot Documentation
  - property: og:title
    content: Core Concepts of Depot
  - property: twitter:title
    content: Core Concepts of Depot
  - name: description
    content: Learn about the fundamental concepts that Depot is built on for faster Docker image builds.
...
Organizations are allocated a certain number of projects based on their plan and can delete old projects when they are no longer needed.
