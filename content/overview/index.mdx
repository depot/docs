...
Builder instances come with 16 CPUs, 32GB of memory, and 50GB of SSD disk. In addition, they run the latest version of [BuildKit](https://github.com/moby/buildkit), the advanced build engine that backs Docker. Our CLI can remotely connect to that instance of BuildKit to execute the build.
