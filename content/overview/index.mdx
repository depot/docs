...
Builder instances come with 4 CPUs, 8GB of memory, and 50GB of SSD disk (scalable up to 8 CPUs and 16B of memory if neccesary). In addition, they run the latest version of [BuildKit](https://github.com/moby/buildkit), the advanced build engine that backs Docker. Our CLI can remotely connect to that instance of BuildKit to execute the build.
