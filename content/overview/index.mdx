...
toc:
  - name: Key Features
    id: key-features
    headings:
      - name: Build isolation & acceleration
        id: build-isolation-acceleration
      - name: Persistent shared caching
        id: persistent-shared-caching
      - name: Multiple platforms
        id: multiple-platforms
      - name: Drop-in replacement
        id: drop-in-replacement
      - name: CI & Dev tool integrations
        id: ci-dev-tool-integrations
      - name: OIDC integrations
        id: oidc-integrations
      - name: Ephemeral Registry
        id: ephemeral-registry
  - name: Next steps
    id: next-steps
---
  ...
  headings={[
    {
      ...
      id: 'key-features',
      headings: [
        {name: 'Build isolation & acceleration', id: 'build-isolation-acceleration'},
        {name: 'Persistent shared caching', id: 'persistent-shared-caching'},
        {name: 'Multiple platforms', id: 'multiple-platforms'},
        {name: 'Drop-in replacement', id: 'drop-in-replacement'},
        {name: 'CI & Dev tool integrations', id: 'ci-dev-tool-integrations'},
        {name: 'OIDC integrations', id: 'oidc-integrations'},
        {name: 'Ephemeral Registry', id: 'ephemeral-registry'},
      ],
    },
