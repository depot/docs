...
meta:
  - title: Introduction | Docs | Depot
  - property: og:title
    content: What is Depot?
  - property: twitter:title
    content: What is Depot?
  - name: description
    content: Depot is a hosted Docker build service with blazing fast compute and persistent caching that can build container images up to 20x faster.
