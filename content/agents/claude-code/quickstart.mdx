...
**Note:** As of recent updates, the `depot claude` command now defaults to running in remote sandboxes rather than locally, providing better isolation and collaboration capabilities.
