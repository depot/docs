...
For a concise explanation of how builder size, build performance, and project layout affect one another, see [Build configuration tradeoffs](/docs/container-builds/how-to-guides/autoscaling#build-configuration-tradeoffs).
...
<ImageWithCaption
  src="/images/docs/stage-level-parallelism.excalidraw.svg"
  alt="Stage level parallelism"
  title="Stage level parallelism"
  className="mx-auto"
/>
...
<ImageWithCaption
  src="/images/docs/multi-platform-build-architecture.excalidraw.svg"
  alt="Multi-platform build architecture"
  title="Multi-platform build architecture"
  className="mx-auto"
/>
...
<ImageWithCaption
  src="/images/docs/multiple-concurrent-builds.excalidraw.svg"
  alt="Multiple concurrent builds on the same builder"
  title="Multiple concurrent builds on the same builder"
  className="mx-auto"
/>
...
<ImageWithCaption
  src="/images/docs/buildkit-deduplication.excalidraw.svg"
  alt="BuildKit deduplication within a build"
  title="BuildKit deduplication within a build"
  className="mx-auto"
/>
...
<ImageWithCaption
  src="/images/docs/cross-build-deduplication-timeline.excalidraw.svg"
  alt="Cross-build deduplication timeline"
  title="Cross-build deduplication timeline"
  className="mx-auto"
/>
...
<ImageWithCaption
  src="/images/docs/bake-shared-project-vs-separate-projects.excalidraw.svg"
  alt="Bake with a shared project compared to separate projects"
  title="Bake: Shared project vs separate projects"
  className="mx-auto"
/>
...
<ImageWithCaption
  src="/images/docs/auto-scaling-behavior.excalidraw.svg"
  alt="Auto-scaling behavior"
