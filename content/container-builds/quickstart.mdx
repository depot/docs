...
---
Build Docker containers up to 40x faster with Depot. Replace docker build with depot build and transform your CI/CD pipeline in under 5 minutes.
...
Click `New project`. In the create a project dialog:
...
**Questions?** Browse the [Depot documentation](/docs) or reach out to our team — we're here to help you build faster.
