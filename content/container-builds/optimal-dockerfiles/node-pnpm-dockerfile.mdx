...
We start with the Node.js LTS image as our build stage base. We enable [`corepack`](https://github.com/nodejs/corepack) to use pnpm without manual installation, and we set up the proper environment variables for pnpm's home directory.
