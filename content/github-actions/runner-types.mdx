...
**Note**: We support the `depot-ubuntu-latest` alias for the current Ubuntu Long-Term Support (LTS) release if you prefer to use an evergreen version.
...
| :---------------------- | :--- | :----- | :-------- | :-------------------- | :--------------- | :----------------- |
| `depot-ubuntu-24.04`    | 2    | 8 GB   | 100 GB    | 2GB                   | $0.006           | 1x                 |
| `depot-ubuntu-24.04-4`  | 4    | 16 GB  | 130 GB    | 4GB                   | $0.012           | 2x                 |
| `depot-ubuntu-24.04-8`  | 8    | 32 GB  | 150 GB    | 8GB                   | $0.024           | 4x                 |
| `depot-ubuntu-24.04-16` | 16   | 64 GB  | 180 GB    | 8GB                   | $0.048           | 8x                 |
| `depot-ubuntu-24.04-32` | 32   | 128 GB | 200 GB    | 16GB                  | $0.096           | 16x                |
| `depot-ubuntu-24.04-64` | 64   | 256 GB | 250 GB    | 32GB                  | $0.192           | 32x                |
...
| Label                       | CPUs | Memory | Disk size | Disk accelerator size | Per-minute price | Minutes multiplier |
| :-------------------------- | :--- | :----- | :-------- | :-------------------- | :--------------- | :----------------- |
| `depot-ubuntu-24.04-arm`    | 2    | 8 GB   | 100 GB    | 2GB                   | $0.006           | 1x                 |
| `depot-ubuntu-24.04-arm-4`  | 4    | 16 GB  | 130 GB    | 4GB                   | $0.012           | 2x                 |
| `depot-ubuntu-24.04-arm-8`  | 8    | 32 GB  | 150 GB    | 8GB                   | $0.024           | 4x                 |
| `depot-ubuntu-24.04-arm-16` | 16   | 64 GB  | 180 GB    | 8GB                   | $0.048           | 8x                 |
| `depot-ubuntu-24.04-arm-32` | 32   | 128 GB | 200 GB    | 16GB                  | $0.096           | 16x                |
| `depot-ubuntu-24.04-arm-64` | 64   | 256 GB | 250 GB    | 32GB                  | $0.192           | 32x                |
...
| Label                       | CPUs | Memory | Disk size | Disk accelerator size | Per-minute price | Minutes multiplier |
| :-------------------------- | :--- | :----- | :-------- | :-------------------- | :--------------- | :----------------- |
| `depot-ubuntu-22.04`        | 2    | 8 GB   | 100 GB    | 2GB                   | $0.006           | 1x                 |
| `depot-ubuntu-22.04-4`      | 4    | 16 GB  | 130 GB    | 4GB                   | $0.012           | 2x                 |
| `depot-ubuntu-22.04-8`      | 8    | 32 GB  | 150 GB    | 8GB                   | $0.024           | 4x                 |
| `depot-ubuntu-22.04-16`     | 16   | 64 GB  | 180 GB    | 8GB                   | $0.048           | 8x                 |
| `depot-ubuntu-22.04-32`     | 32   | 128 GB | 200 GB    | 16GB                  | $0.096           | 16x                |
| `depot-ubuntu-22.04-64`     | 64   | 256 GB | 250 GB    | 32GB                  | $0.192           | 32x                |
| `depot-ubuntu-22.04-arm`    | 2    | 8 GB   | 100 GB    | 2GB                   | $0.006           | 1x                 |
| `depot-ubuntu-22.04-arm-4`  | 4    | 16 GB  | 130 GB    | 4GB                   | $0.012           | 2x                 |
| `depot-ubuntu-22.04-arm-8`  | 8    | 32 GB  | 150 GB    | 8GB                   | $0.024           | 4x                 |
| `depot-ubuntu-22.04-arm-16` | 16   | 64 GB  | 180 GB    | 8GB                   | $0.048           | 8x                 |
| `depot-ubuntu-22.04-arm-32` | 32   | 128 GB | 200 GB    | 16GB                  | $0.096           | 16x                |
| `depot-ubuntu-22.04-arm-64` | 64   | 256 GB | 250 GB    | 32GB                  | $0.192           | 32x                |
...
macOS runners use instances with M2 chips running macOS 14 or 15, or M4 chips running macOS 26. Their EBS volume is provisioned with 12000 IOPS and 1000 MB/s throughput. Like the Linux runners, the macOS runners also have a disk accelerator.

The following labels are available:

| Label                                   | CPUs | Memory | Disk size | Disk accelerator size | Per-minute price |
| :-------------------------------------- | :--- | :----- | :-------- | :-------------------- | :--------------- |
| `depot-macos-26` (`depot-macos-latest`) | 8    | 24 GB  | 400 GB    | 2 GB                  | $0.08            |
| `depot-macos-15`                        | 8    | 24 GB  | 400 GB    | 2 GB                  | $0.08            |
...
- [`depot-macos-26`](https://github.com/actions/runner-images/blob/main/images/macos/macos-26-arm64-Readme.md) and `depot-macos-latest`
