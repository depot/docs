...
Depot supports a variety of [runner types and sizes][runner type docs](/docs/github-actions/runner-types), including Intel and Arm runners with up to 64 CPUs.
