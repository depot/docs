...
**Note: During beta, we are limiting the max number of CPUs you can request to 8 but 16 & 32 options are available for those who need them. We currently only support Intel runners at the moment but will be launching ARM runners in beta shortly.**
