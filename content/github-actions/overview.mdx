...
import {CTA} from '~/components/marketing/post/common/PostCTA'
...
| **GitHub Actions minutes** | 2,000 included/month<br/>+ $0.006/minute after | 20,000 included/month<br/>+ $0.006/minute after | Custom                |
...
<CTA href="/sign-up" button="Try it free for 7 days" data-ph-capture-attribute-button-id="github-actions-docs-cta">
...
- Developer plan: 2,000 minutes included, $0.006/minute after
- Startup plan: 20,000 minutes included, $0.006/minute after
