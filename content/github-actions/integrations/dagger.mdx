...
From the [Dagger Cloud](https://dagger.cloud/) UI, generate a [Dagger Cloud token](https://docs.dagger.io/0.21/reference/configuration/cloud/) and copy it to your clipboard.

<img
  class="mx-auto h-auto max-w-[500px]"
  src="/images/integrations/dagger-cloud-token-setup.webp"
  alt="Dagger Cloud page showing the Dagger Cloud token and CI setup guide button"
/>
...
<img
  class="mx-auto"
  src="/images/integrations/connect-to-dagger-cloud.webp"
  alt="Depot Dagger page with the Connect to Dagger Cloud button"
/>
