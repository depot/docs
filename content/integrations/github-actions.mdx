...
toc:
  ...
  - name: Examples
    ...
    headings:
      ...
      - name: Build and push to Docker Hub with OIDC token exchange
        id: build-and-push-to-dockerhub-with-oidc-token-exchange
      - name: Build and push with Depot API tokens
        id: build-and-push-with-depot-api-tokens
...
### Build and push with Depot API tokens
