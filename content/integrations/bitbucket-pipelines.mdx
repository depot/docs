...
longTitle: Use Depot in your Bitbucket Pipelines
description: Speed up your container builds by using Depot in your existing Bitbucket Pipelines.

meta:
  - title: Bitbucket Pipelines | Integrations | Depot Documentation
  - property: og:title
    content: Use Depot in your Bitbucket Pipelines
  - property: twitter:title
    content: Use Depot in your Bitbucket Pipelines
  - name: description
    content: Speed up your container builds by using Depot in your existing Bitbucket Pipelines.
