---
title: GitLab CI
longTitle: Use Depot in your GitLab CI job
description: Use Depot to get faster container image builds without needing Docker in Docker for GitLab CI

meta:
  - title: GitLab CI | Integrations | Depot Documentation
  - property: og:title
    content: Use Depot in your GitLab CI job
  - property: twitter:title
    content: Use Depot in your GitLab CI job
  - name: description
    content: Use Depot to get faster container image builds without needing Docker in Docker for GitLab CI
...
### Basic build and push to GitLab registry
