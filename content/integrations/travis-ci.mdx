---
title: Travis CI
longTitle: Use Depot in your Travis CI workflow
description: Get faster container image builds from your existing Travis CI workflow.

meta:
  - title: Travis CI | Integrations | Depot Documentation
  - property: og:title
    content: Use Depot in your Travis CI workflow
  - property: twitter:title
    content: Use Depot in your Travis CI workflow
  - name: description
    content: Get faster container image builds from your existing Travis CI workflow.
