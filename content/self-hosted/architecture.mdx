...
longTitle: Architecture and Security of Self-hosted Depot Builders
...
meta:
  - title: Architecture and Security | Self-hosted | Depot Documentation
  - property: og:title
    content: Architecture and security of self-hosted Depot builders
  - property: twitter:title
    content: Architecture and security of self-hosted Depot builders
  - name: description
    content: Self-hosted builders consist of several components, all of them open-source.
...
<DocsTOC
  headings={[
    ...
    },
    {
      ...
      id: "security",
      headings: [
        { name: "General Depot Security", id: "general-depot-security" },
      ],
    },
  ]}
/>
