...
After you have created a connection and provisioned the infrastructure, you can choose to use that new connection on a per-project basis if you are on the [Business or Enterprise plan](/pricing).
