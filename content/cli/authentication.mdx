...
longTitle: Options for authenticating builds with the Depot CLI
description: We provide three different methods you can use to authenticate your container image builds.

meta:
  - title: Authentication | CLI | Depot Documentation
  - property: og:title
    content: Options for authenticating builds with the Depot CLI
  - property: twitter:title
    content: Options for authenticating builds with the Depot CLI
  - name: description
    content: We provide three different methods you can use to authenticate your container image builds.
