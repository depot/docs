...
**Important:** As of recent updates, `depot claude` now defaults to running in a remote sandbox environment rather than locally. This provides better isolation, reproducibility, and collaboration capabilities.
